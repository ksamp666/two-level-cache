 ...
 */
public class FifoStrategy<KeyType> implements Strategy<KeyType> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!FifoStrategy.class.isAssignableFrom(obj.getClass())) {
            return false;
        }
        final FifoStrategy objectToCompareWith = (FifoStrategy) obj;
